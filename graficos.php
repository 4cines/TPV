            ...
            <div class="col-12 col-lg-5 col-xl-4 mt-5">
                <aside>
                    ...
                    <div class="list-group">
                        ...
                        <div class="chart-item list-group-item list-group-item-action" data-route="getSaleChartData" data-chart="sales_average_day" data-type="line" aria-current="true">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Ventas (€) media por día</h5>
                            </div>
                        </div>

                        <div class="chart-item list-group-item list-group-item-action" data-route="getSaleChartData" data-chart="sales_average_month" data-type="line" aria-current="true">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Ventas (€) media por mes</h5>
                            </div>
                        </div>

                        <div class="chart-item list-group-item list-group-item-action" data-route="getSaleChartData" data-chart="sales_average_year" data-type="line" aria-current="true">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Ventas (€) media por año</h5>
                            </div>
                        </div>
